...
const createMaintenance = (request, response, pool) => {
  ...
  pool.query(
    ...
    INSERT INTO public.maintenance(
        date_fin, date_debut, niveau, priorite, etat)
       VALUES ($1, $2,$3, $4,$5);
    -- inserting in the reparer table
    INSERT INTO public.reparer(
       mecanicien, vehicule, piece,huile)
       VALUES ($6, $7,$8, $9) RETURNING *;
       commit;`,
    [
      date_fin,
      date_debut,
